...
#Case Type
browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[1]/div[2]/div/div/div/div/button").click
browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[1]/div[2]/div/div/div/ul/li/div[9]/a/div").click
#Case SubType
browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[2]/div[2]/div/div/div/div/button").click
browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[2]/div[2]/div/div/div/ul/li/div[5]/a/div").click

#Geographic Region of case
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[3]/div[2]/div/div/div/div/button").click
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[3]/div[2]/div/div/div/ul/li/div[8]/a/div").click	
#Country of the case
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[4]/div[2]/div/div/div/div/button").click
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[4]/div[2]/div/div/div/ul/li/div[16]/a/div").click
#Whats the language of the parties' principal contract
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[5]/div[2]/div/div/div/div/button").click
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[5]/div[2]/div/div/div/ul/li/div[6]/a/div").click 
#Contract Currency
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[6]/div[2]/div/div/div/div/button").click
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[6]/div[2]/div/div/div/ul/li/div[11]/a/div").click
#Was the case filed as mediation or arbitration
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[7]/div[2]/div/div/div/label[1]/span").click
#Did mediation successfully conclude the case - "No"
	browser.find_element(css: "div.row:nth-child(8) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > label:nth-child(2) > span:nth-child(2)").click
	#If no, what outcome?
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[9]/div[2]/div/div/textarea").send_keys "Case resulted in a mis-mediation"
# Did the case continue onto arbitration, after being filed for mediation
browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[10]/div[2]/div/div/div/label[2]/span").click
#NEXT
	browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[2]/button").click
	sleep(2)
