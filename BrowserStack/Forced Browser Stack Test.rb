...
browser.find_element(id: "user_email_login").click
browser.find_element(id: "user_email_login").send_keys "drd@sparcedge.com"

#browserstack Password
browser.find_element(id: "user_password").click
browser.find_element(id: "user_password").send_keys "Sparcrules14"
