...
browser.find_element(xpath: "/html/body/div/div/div[5]/div/form/div[1]/div[2]/div[3]/div[2]/div/div/div/ul/li/div[9]/a/div").click
		# ountry where the case was filed:
		browser.find_element(css: "body > div.ng-scope > div > div:nth-child(5) > div > form > div:nth-child(2) > div.intake-question-list > div:nth-child(4) > div:nth-child(2) > div > div > div > div > button").click
		browser.find_element(xpath: "/html/body/div[4]/div/div[5]/div/form/div[1]/div[2]/div[4]/div[2]/div/div/div/ul/li/div[6]/a/div").click

#Contract Currency:
browser.find_element(css: "body > div.ng-scope > div > div:nth-child(5) > div > form > div:nth-child(2) > div.intake-question-list > div:nth-child(5) > div:nth-child(2) > div > div > div > div > button").click
...
browser.find_element(xpath: "/html/body/div[4]/div/div[5]/div/form/div[1]/div[2]/div[6]/div[2]/div/div/div/label[2]/span").click
