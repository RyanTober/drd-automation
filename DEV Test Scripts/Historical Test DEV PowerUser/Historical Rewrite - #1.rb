...
#Home page
	#Enters new historical case.
		browser.find_element(css: "a.btn:nth-child(1)").click
...
#1st drop Down
		...
		# XPATH IF NEEDED = html/body/div/div/div[5]/div/form/div[1]/div[2]/div[1]
			browser.find_element(xpath: "//div[2]/div/div/div/input[1]").send_keys "ae"
...
# Geographic Region of the case:
		browser.find_element(css: "div.error:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > button:nth-child(1)").click
		browser.find_element(css: "div.ui-select-choices-row:nth-child(5) > a:nth-child(1) > div:nth-child(1)").click

# Country of the case:
		browser.find_element(xpath: "/html/body/div[3]/div/div[5]/div/form/div[1]/div[2]/div[4]/div[2]/div/div/div/div/button").click
		browser.find_element(xpath: "/html/body/div[3]/div/div[5]/div/form/div[1]/div[2]/div[4]/div[2]/div/div/div/ul/li/div[6]/a/div").click
#Contract Currency:
browser.find_element(xpath: "/html/body/div[3]/div/div[5]/div/form/div[1]/div[2]/div[5]/div[2]/div/div/div/div/button").click
browser.find_element(xpath: "/html/body/div[3]/div/div[5]/div/form/div[1]/div[2]/div[5]/div[2]/div/div/div/ul/li/div[10]/a/div").click
